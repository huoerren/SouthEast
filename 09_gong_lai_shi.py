...
global unfit_urls
unfit_urls = ['http://www.cdepb.gov.cn/cdepbws/Web/Template/GovDefaultInfo.aspx?cid=855&aid=18515']
...
def getDataFromUrl(link,title):
    if link not in unfit_urls:
        ...
        # print([link,Name, Category  , According  , Measure  ])
...
def getLinks():
    for i in range(1,19):
        url = 'http://www.cdepb.gov.cn/cdepbws/Web/Template/GovDefaultList.aspx?cid=855&page='+str(i)
